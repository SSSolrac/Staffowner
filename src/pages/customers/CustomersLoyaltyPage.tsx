...
export const CustomersLoyaltyPage = () => {
  ...
  const filtered = useMemo(() => customers.filter((customer) => {
    ...
    const byQuery = customer.name.toLowerCase().includes(query.toLowerCase()) || customer.email.toLowerCase().includes(query.toLowerCase()) || customerCode.toLowerCase().includes(query.toLowerCase());
