        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center p-4 z-20">
          <div className="w-full max-w-xl rounded-lg border bg-white dark:bg-slate-800 p-4 space-y-3">
            ...
            <div className="border rounded p-3 text-sm">
              ...
              <button className="border rounded px-2 py-1 mt-2" onClick={() => toast.info('Adjustment request recorded. Enable approval workflow once loyalty backend integration is completed.')}>Request adjustment</button>
            </div>
          </div>
        </div>
      )}
